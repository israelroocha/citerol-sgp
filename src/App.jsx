      ...
      {bordados.map((b,i)=>{
        ...
        return(
          <div key={k} style={{
            ...
            {jaExecutado && !executado.dispensado && executado.fileIds && executado.fileIds.length > 0 && <div>
              <div style={{...F.body,fontSize:11,fontWeight:700,color:C.gray600,textTransform:"uppercase",letterSpacing:"0.06em",marginBottom:6}}>Arquivo{executado.fileIds.length!==1?"s":""} programado{executado.fileIds.length!==1?"s":""}</div>
              <ArquivosBox fileIds={executado.fileIds} emptyText=""/>
            </div>}
