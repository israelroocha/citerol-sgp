...
function AcaoTab({order,me,uploadFile,setUploadFile,uploadName,setUploadName,obsText,setObsText,actionDone,setActionDone,actionMsg,setActionMsg,itemSel,itemDest,nSel,allDestDefined,skus,itensDirecionaveis,toggleItemSel,selAllItems,setDestSel,setDestAll,setDestOne,onAction,isMobile,loadingDet,setTemPendencias}){
  ...
  return(
    <div style={{padding:20,display:"flex",flexDirection:"column",gap:16}}>
      ...
      {/* Barra de progresso do pagamento (igual ao app de Pagamentos): recebido x valor do pedido */}
      {etapa==="Análise de Frete"&&(()=>{
        // Valor do pedido = produtos + frete (mesma régua do app de Pagamentos)
        const valorPed=Number(order.valor||0)+Number(order.valorFrete||0);
        ...
        return(
          <div style={{background:C.white,border:`1px solid ${C.gray200}`,borderRadius:8,padding:"12px 14px"}}>
            ...
            {/* Tabela de pagamentos (quando o app de Pagamentos grava cit_payments_json) */}
