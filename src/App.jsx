...
const GRUPOS_MENU = ["Principal","Indicadores","Separação","PCP","Ocorrência","Amostra","Operação","Faturamento","Pausados","Ferramentas","Sistema"];
...
function etapasDoSnapshot(pedidos){
  const presentes=new Set((pedidos||[]).map(o=>o.etapa).filter(Boolean));
