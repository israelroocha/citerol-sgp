  ...
  return(
    <div style={{padding:20,display:"flex",flexDirection:"column",gap:16}}>
      ...
      {bordados.map((b,i)=>{
        ...
        const obsRelevante = etapa==="Programação" ? b.obs_programacao : "";
        return(
          <div key={k} style={{border:`1px solid ${C.gray200}`,borderRadius:10,padding:14,display:"flex",flexDirection:"column",gap:12}}>
            ...
            {obsRelevante && (
              <div style={{background:"#fef3c7",border:`2px solid ${C.amber}`,borderLeft:`6px solid ${C.amber}`,borderRadius:8,padding:"12px 14px",display:"flex",gap:10,alignItems:"flex-start"}}>
                ...
                <div style={{flex:1,minWidth:0}}>
                  <div style={{...F.title,fontSize:11,fontWeight:700,color:"#92400e",letterSpacing:"0.08em",textTransform:"uppercase",marginBottom:4}}>Observação do vendedor para a Programação</div>
                  <div style={{...F.body,fontSize:14,color:"#78350f",fontWeight:600,lineHeight:1.45,whiteSpace:"pre-wrap",wordBreak:"break-word"}}>{obsRelevante}</div>
                </div>
              </div>
            )}
            {comDificuldade&&<div>
        ...
        <div style={{padding:"14px 20px",borderBottom:`1px solid ${C.gray200}`,display:"flex",justifyContent:"space-between",alignItems:"flex-start",gap:8,flexShrink:0}}>
          <div style={{flex:1,minWidth:0}}>
            ...
            <div style={{display:"flex",alignItems:"center",gap:8,marginTop:6,flexWrap:"wrap"}}>
              <BadgeSeparacao status={order.statusSeparacao} qtdSep={order.qtdSeparada} qtdTot={order.qtdTotal} qtdItensSep={order.qtdItensSeparados} totalItens={order.totalItensSeparacao} size="lg"/>
            </div>
