        ...
        return(
          <Card key={o.id} style={{marginBottom:14,borderLeft:`3px solid ${sla.st==="late"?C.red:sla.st==="risk"?C.amber:STAGE_COLOR[o.etapa]||C.gray300}`}}>
            ...
            <div onClick={()=>toggleItens(o.id)}
              ...
              <span style={{...F.body,fontSize:12,fontWeight:700,color:C.gray600}}>Itens do pedido — {o.items.length}</span>
              <span style={{...F.body,fontSize:11,color:allDefined?C.green:C.amber,fontWeight:600}}>· {o.items.filter(it=>dm[it.id||it.sku]).length}/{o.items.length} direcionados</span>
