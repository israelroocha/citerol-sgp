...
const NAV_ITEMS = [
  ...
  {id:"executados",              label:"Programações Feitas",      icon:"check",   grupo:"Amostra"},
...
// ─── ORDER MODAL ─────────────────────────────────────────────────────────────
// ─── TELA: PROGRAMAÇÕES FEITAS (histórico da programadora) ─────────────────
// Módulo de menu que lista TODOS os bordados que a pessoa já programou/avançou
// (fonte: relatório de programação no Supabase). Por padrão mostra só as dela;
// dá pra alternar pra ver de todos.
function MinhasProgramacoes({user}){
  ...
  return (
    <div style={{padding:20}}>
      <PageH title="Programações Feitas" sub="Bordados que você já programou e avançou." onRefresh={carregar} refreshing={loading}/>
...
function AppInner(){
  ...
  const TITLES={
    ...
    programacao:"Programação",executados:"Programações Feitas",amostra_digital:"Amostra Digital",amostra_fisica:"Amostra Física",
      ...
      <div style={{display:"flex",flex:1,overflow:"hidden"}}>
        ...
        <div style={{flex:1,display:"flex",flexDirection:"column",overflow:"hidden"}}>
          ...
          <div className="sgp-scroll" style={{flex:1,overflowY:"auto",paddingBottom:isMobile?70:0}}>
            ...
            {page==="executados"&&<MinhasProgramacoes user={user}/>}
