        ...
        <div style={{padding:"14px 20px",borderBottom:`1px solid ${C.gray200}`,display:"flex",justifyContent:"space-between",alignItems:"flex-start",gap:8,flexShrink:0}}>
          ...
          <div style={{display:"flex",gap:8,alignItems:"center",flexShrink:0}}>
            <button
              ...
              style={{background:C.white,border:`1.5px solid ${C.amber}55`,borderRadius:6,padding:"7px 12px",cursor:"pointer",display:"inline-flex",alignItems:"center",gap:6,color:"#92400e",fontWeight:700,fontSize:12,...F.body}}
              onMouseEnter={e=>{e.currentTarget.style.background=C.amber+"12";}}
              onMouseLeave={e=>{e.currentTarget.style.background=C.white;}}>
              <Ic n="clock" s={14} c="#92400e"/> Pendência Comercial
            </button>
            <button
        ...
        {(o.produtos||[]).map((p,i)=>{
          ...
          <div key={i} className="produto-row" style={{display:"flex",gap:12,alignItems:"stretch",border:"1px solid #555",borderRadius:8,padding:8}}>
            ...
            <div style={{flex:1,minWidth:0,display:"flex",flexDirection:"column",justifyContent:"center"}}>
              ...
              {/* Grades com caixinha ✓/✗ pra distinguir em B&W — sem tachado (dificultava leitura) */}
