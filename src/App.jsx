    ...
    return(
      <div style={{padding:20,display:"flex",flexDirection:"column",gap:16}}>
        ...
        <button onClick={concluirConferencia} disabled={enviandoConf}
          style={{background:enviandoConf?"#ccc":"#059669",color:C.white,border:"none",borderRadius:7,padding:"12px 24px",cursor:enviandoConf?"wait":"pointer",...F.body,fontWeight:700,fontSize:14,display:"inline-flex",alignItems:"center",gap:8,alignSelf:"flex-start"}}>
          <Ic n="check" s={16} c={C.white}/> {enviandoConf?"Confirmando...":"Conferência concluída — avançar"}
        </button>
      </div>
    );
  }
