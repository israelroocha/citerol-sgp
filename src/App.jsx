...
const STAGE_COLOR = {
  ...
  "Expedição":C.teal,"Análise de Frete":"#0891b2","Faturamento":C.green,
};
...
const SLA_DEF = {
  ...
  "Bordado Externo":120,"Expedição":8,"Análise de Frete":8,"Faturamento":4,
};
...
const NAV_ITEMS = [
  ...
  {id:"analise_frete",           label:"Análise de Frete",         icon:"send",    grupo:"Operações"},
...
function OrderModal({order: _orderLeve,me,onClose,usuarios,onAction,isMobile,slaCfg}){
  ...
  const ETAPAS_COM_ACAO=["Direcionamento","Retirar e Conferir","Programação","Amostra Digital","Amostra Física","Aprovação de Amostra Digital","Aprovação de Amostra Física","Bordado Interno","Bordado Externo","Bordado Interno e Externo","Expedição","Análise de Frete"];
