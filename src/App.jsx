  ...
  return(
    <div style={{padding:20}}>
      <div style={{display:"flex",justifyContent:"space-between",alignItems:"flex-start",gap:12,flexWrap:"wrap"}}>
        <PageH title="Silk / DTF" sub="Pedidos com peças de silk ou DTF, na etapa em que cada um está. Silk/DTF é personalização da peça, não uma fase do pedido." onRefresh={carregar} refreshing={loading}/>
            ...
            <div style={{display:"flex",justifyContent:"space-between",alignItems:"flex-start",gap:12,flexWrap:"wrap"}}>
              ...
              <div style={{display:"flex",gap:8,alignItems:"center",flexWrap:"wrap"}}>
                ...
                {done
                  ...
                  : o.etapa==="Conferência e Direcionamento"
                    ? <Btn label={busy?"Enviando...":"Silk/DTF concluído"} icon="check" variant="success" disabled={!!busy} onClick={()=>concluir(o)}/>
                    : <span style={{...F.body,fontSize:11,color:C.gray500}}>Libera na Conferência e Direcionamento</span>}
              </div>
            </div>
