  ...
  return(
    <div style={{padding:24,display:"flex",flexDirection:"column",gap:18}}>
      ...
      {grupo==="aberto"&&!loading&&<>
        ...
        {listaSituacao.length===0?<div style={{...F.body,color:C.gray400,fontSize:14,textAlign:"center",padding:40,background:C.white,borderRadius:8,border:`1px solid ${C.gray200}`}}>{q.length>=3&&finalizadosAchados.length>0
            ? "Nenhum pedido em aberto com essa busca — veja os já faturados acima."
