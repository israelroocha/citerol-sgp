      ...
      {(etapa==="Bordado Interno"||etapa==="Bordado Externo"||etapa==="Bordado Interno e Externo") && (() => {
        ...
        return (
          <div>
            ...
            {/* Arquivos da programação anexados — pra bordadeira executar o bordado */}
            {(() => {
              const fileIds = String(order.arqProgramacao||"").split(";").filter(Boolean);
              ...
              return (
                <div style={{marginTop:14}}>
                  <label style={{...F.body,fontSize:11,fontWeight:700,color:C.gray600,textTransform:"uppercase",letterSpacing:"0.06em",display:"block",marginBottom:8}}>
                    Arquivos da programação ({fileIds.length}) — anexados pela programadora
                  </label>
                  <ArquivosBox fileIds={fileIds} emptyText="Nenhum arquivo de programação anexado."/>
                </div>
              );
            })()}
          </div>
