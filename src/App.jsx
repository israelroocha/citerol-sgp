              ...
              <div style={{display:"flex",justifyContent:"space-between",alignItems:"flex-start",flexWrap:"wrap",gap:10}}>
                <div style={{flex:1,minWidth:0}}>
                  ...
                  {etapa==="Programação"&&<div style={{...F.body,fontSize:11,color:C.gray600,marginBottom:6,display:"flex",alignItems:"center",gap:4}}>
                    ...
                    {o.dataFechamento?<>Fechamento do pedido: <strong style={{color:C.gray700}}>{fmtDS(o.dataFechamento)}</strong></>:"Data de fechamento não informada"}
                  </div>}
